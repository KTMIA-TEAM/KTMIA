...
def main(args):
    ...
    victim_model.test(victim_test_loader, "Victim Model Test")
    ...
    shadow_model.test(shadow_train_loader, "Shadow Model Train")
    shadow_model.test(shadow_test_loader, "Shadow Model Test")
    ...
    for layer in args.transfer_layer_list[::-1]:
        if layer == "conv1":
            continue
    ...
    attacker = MiaAttack(
        ...
        exploit_layer_list=args.transfer_layer_list)
